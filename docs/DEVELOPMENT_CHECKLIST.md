...
Den äldre, mer utförliga versionen (med historik/anteckningar) finns i: `DEVELOPMENT_CHECKLIST_ARCHIVE.md`.

## 📍 Status
- **Release**: v2.1.2 (pending)
- **Nästa release**: v2.1.3 (pending)
...
#### P0 (högsta prioritet)
- [x] **BUG: Ready-status syncar inte stabilt i lobby**
	...
	- Fix: Snapshot-broadcast + offline queue i client (commit `d7f6434`).

#### P1
- [x] **Svensk tid för “Senast spelat” (GMT+1 / Europe/Stockholm)**
...
- [x] Diskreta toasts (enhetlig blå) för lobby-events (t.ex. join/kick)
- [x] Snabbare bokstavsval (minskad lagg och mindre layout-jitter)
...
- [x] **Kick-funktion (spelledare/room owner)**
	- Endast room creator kan kicka.
	- Implementerat i lobby när room status är `waiting`.
	- Kickad spelare lämnar direkt, ready-state rensas, och får tydligt meddelande (toast).
	- Re-join fungerar igen när man går med på nytt.
	- [ ] Under spel: definiera policy (walkover/abandon?) om vi vill stödja kick även då.

- [x] **Rate limit: skapa rum max 1 per användare per 5 min (eller max 1 aktivt rum)**
...
### 9.6 Lobby UX – mobil
- [x] **Start-knapp alltid synlig på mobil (ingen scroll för att starta)**
